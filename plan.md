# Initial Project Analysis & Implementation Planning Prompt

Read and analyze the entire project before making any code changes.

## Documents to Read

Start by reading the following files in order:

1. CLAUDE.md
2. README.md
3. All files inside the `docs/` folder
...
After reading all documentation, provide a complete implementation analysis.

Include:

### 1. Project Overview

Explain your understanding of the project.
...
Explain the complete workflow from:
...
Mention every important business rule and dependency.
...
Review the database documentation.
...
Explain how you would implement the backend.
...
Provide the exact order in which the application should be developed.
...
Without changing the documented business workflow,
...
list all clarification questions before implementation.
...
Prepare a complete implementation roadmap from project setup to production deployment.
...
* Do NOT make assumptions.
* Use the documentation as the single source of truth.
* Clearly explain your reasoning.
* Identify missing requirements if any.
* Recommend improvements while keeping the current project scope.

At the end, provide a detailed implementation plan that can be followed step by step during development.
