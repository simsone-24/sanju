...
export async function uploadProfilePhoto(id: string, file: File): Promise<UserDetail> {
...
export async function getProfilePhotoObjectUrl(id: string): Promise<string> {
